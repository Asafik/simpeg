...
<aside class="fixed top-0 left-0 h-full w-[270px] bg-white text-gray-800 border-r border-gray-200/80 shadow-sm z-50 
    ...
    <div class="p-4 border-t border-gray-100 flex-shrink-0">
        <div class="flex items-center gap-3 px-2">
            <img src="{{ Auth::user()->avatar ?? 'https://ui-avatars.com/api/?name=Admin+Dinas&background=1e40af&color=fff' }}" alt="User Avatar" class="w-9 h-9 rounded-full object-cover border border-gray-200">
