...
<head>
    ...
    <title>403 - Akses Ditolak | SIMPEG-SP</title>
...
<body class="bg-gray-50 text-gray-800 antialiased font-sans min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full text-center">
        ...
        <div class="relative mb-8 inline-flex items-center justify-center">
            ...
            <span class="absolute -top-1 -right-1 bg-red-500 text-white text-xs font-bold px-2 py-0.5 rounded-full shadow-sm">403</span>
        </div>

        <!-- Error Message -->
        <h1 class="text-2xl font-extrabold text-gray-900 tracking-tight mb-2">Akses Ditolak!</h1>
        <p class="text-sm text-gray-500 mb-8 leading-relaxed">
            Maaf, Anda tidak memiliki izin atau hak akses untuk membuka halaman ini. Halaman ini hanya dapat diakses oleh Administrator Dinas.
        </p>
