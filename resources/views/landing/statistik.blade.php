    ...
    <main class="w-full px-6 md:px-12 py-12 space-y-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            <div class="bg-white rounded-2xl p-6 border border-gray-200/80 shadow-sm space-y-2">
                ...
                <h3 class="text-3xl font-extrabold text-gray-900">{{ number_format($totalPegawai) }}</h3>
                <span class="text-[11px] text-emerald-600 font-semibold flex items-center gap-1">
                    <i class="fas fa-arrow-up text-[9px]"></i> Terdata di SIMPEG-SP
                </span>
            </div>

            <div class="bg-white rounded-2xl p-6 border border-gray-200/80 shadow-sm space-y-2">
                <p class="text-xs font-bold text-gray-400 uppercase tracking-wider">Pegawai Bersertifikasi</p>
                <h3 class="text-3xl font-extrabold text-gray-900">{{ number_format($totalSerdik) }}</h3>
                <span class="text-[11px] text-blue-600 font-semibold">{{ $persenSerdik }}% dari total guru</span>
            </div>

            <div class="bg-white rounded-2xl p-6 border border-gray-200/80 shadow-sm space-y-2">
                <p class="text-xs font-bold text-gray-400 uppercase tracking-wider">Status PNS / PPPK</p>
                <h3 class="text-3xl font-extrabold text-gray-900">{{ number_format($totalPns + $totalPppk + $totalPppkPw) }}</h3>
                <span class="text-[11px] text-emerald-600 font-semibold">Aparatur Negara</span>
            </div>

            <div class="bg-white rounded-2xl p-6 border border-gray-200/80 shadow-sm space-y-2">
                <p class="text-xs font-bold text-gray-400 uppercase tracking-wider">Satuan Pendidikan</p>
                <h3 class="text-3xl font-extrabold text-gray-900">{{ $totalSekolah }}</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-2xl p-6 border border-gray-200/80 shadow-sm space-y-4">
                <div class="flex items-center justify-between border-b border-gray-100 pb-3">
                    <h3 class="font-bold text-base text-gray-900">Sebaran Kualifikasi Kriteria</h3>
                ...
                <div class="space-y-3 pt-2">
                    <div>
                        <div class="flex justify-between text-xs font-bold text-gray-700 mb-1">
                            ...
                            <span>{{ $persenPns }}% ({{ $totalPns }} Pegawai)</span>
                        </div>
                        <div class="w-full bg-gray-100 rounded-full h-3">
                            <div class="bg-blue-800 h-3 rounded-full" style="width: {{ $persenPns }}%"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex justify-between text-xs font-bold text-gray-700 mb-1">
                            ...
                            <span>{{ $persenPppk }}% ({{ $totalPppk }} Pegawai)</span>
                        </div>
                        <div class="w-full bg-gray-100 rounded-full h-3">
                            <div class="bg-blue-600 h-3 rounded-full" style="width: {{ $persenPppk }}%"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex justify-between text-xs font-bold text-gray-700 mb-1">
                            ...
                            <span>{{ $persenPppkPw }}% ({{ $totalPppkPw }} Pegawai)</span>
                        </div>
                        <div class="w-full bg-gray-100 rounded-full h-3">
                            <div class="bg-amber-500 h-3 rounded-full" style="width: {{ $persenPppkPw }}%"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex justify-between text-xs font-bold text-gray-700 mb-1">
                            ...
                            <span>{{ $persenNonAsn }}% ({{ $totalNonAsn }} Pegawai)</span>
                        </div>
                        <div class="w-full bg-gray-100 rounded-full h-3">
                            <div class="bg-gray-400 h-3 rounded-full" style="width: {{ $persenNonAsn }}%"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 border border-gray-200/80 shadow-sm space-y-4">
                <div class="flex items-center justify-between border-b border-gray-100 pb-3">
                    ...
                    <span class="text-xs font-semibold text-emerald-800 bg-emerald-100 px-2.5 py-1 rounded-full">Real-time</span>
                </div>
                <div class="space-y-4 pt-2">
                    <div class="p-4 rounded-xl bg-emerald-50 border border-emerald-200 flex items-center justify-between">
                        ...
                        <span class="text-lg font-extrabold text-emerald-800">{{ number_format($berkasValid) }}</span>
                    </div>
                    ...
                    <div class="p-4 rounded-xl bg-blue-50 border border-blue-200 flex items-center justify-between">
                        ...
                        <span class="text-lg font-extrabold text-blue-800">{{ number_format($totalSerdik) }}</span>
                    </div>
                    ...
                    <div class="p-4 rounded-xl bg-amber-50 border border-amber-200 flex items-center justify-between">
                        ...
                        <span class="text-lg font-extrabold text-amber-800">{{ number_format($berkasPerbaikan) }}</span>
                    </div>
                </div>
            </div>
        </div>
